...
parser.add_argument(
    "--device", type=str, default='cuda:2', help="Device to use. Like cuda, cuda:0 or cpu"
)
parser.add_argument(
    "--dims",
    type=int,
...
parser.add_argument(
    ...
    default=['/home/kaden/Desktop/GAN_Watermarking (another copy)/stylegan+decoder/sample', '/home/kaden/Downloads/archive/img_align_celeba/split']
)
